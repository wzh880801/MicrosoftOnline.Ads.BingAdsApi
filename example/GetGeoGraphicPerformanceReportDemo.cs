...
{
    public class GetGeoGraphicPerformanceReportDemo : IDemo
    {
        ...
        public GetGeoGraphicPerformanceReportDemo(DateTime start, DateTime end, long customerId)
        {
        ...
        public void Run()
        {
            ...
            Console.WriteLine("Description:\tGeographicPerformanceReportDemo");
        ...
        ReportRequest BuildRequest(long[] accountIds)
        {
            return new GeographicalLocationReportRequest
            {
                ...
                Columns = new GeographicalLocationReportColumn[]
                {
                    GeographicalLocationReportColumn.AccountId,
                    GeographicalLocationReportColumn.AccountName,
                    GeographicalLocationReportColumn.AccountNumber,
                    GeographicalLocationReportColumn.Impressions,
                    GeographicalLocationReportColumn.Clicks,
                    GeographicalLocationReportColumn.Spend,
                    GeographicalLocationReportColumn.Conversions,
                    GeographicalLocationReportColumn.TimePeriod
                },
                Filter = null,
                ...
                ReportName = "GeoGraphicPerformanceReport",
        ...
        void Process(object sender, BulkProcessEventArgs e)
        {
            ...
            Console.WriteLine("{0}\t{1}", e.RowValues["GregorianDate"], e.RowValues["Spend"]);
        }
    }
}
